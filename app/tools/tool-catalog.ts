...
export const TOOLS_CATALOG: SiteTool[] = [
  ...
  },
  {
    ...
    description:
      "Build the monthly NWCT Arts Council print calendar from a CSV of events. Auto-maps columns, opens a spreadsheet-style editor with validation, then groups events into Daily, Long Runs, and Workshops for a print-ready preview. Save the session as JSON, download an edited CSV, print, or export to PDF — all in the browser.",
    status: "live",
    features: [
      "CSV upload with PapaParse",
      "Smart column auto-mapping",
      "AG Grid spreadsheet editor",
      "Inline edit, duplicate, delete",
      "Required-field validation",
      "Date sanity checks",
      "Auto-group Short/Long/Workshop",
      "Print-ready preview",
      "JSON save/load",
      "PDF export",
      "100% browser-based",
    ...
    icon: "📅",
    href: "/tools/nwct-calendar",
    accent: "#D97706",
    usedBy: "NWCT Arts Council monthly print calendar production",
  },
  {
    id: "scheduler",
    name: "ASAP! Scheduler",
