...
export default function CsvDedupPage() {
  return (
    <div style={{ paddingTop: "64px", minHeight: "100vh", backgroundColor: "#f8fafc", fontFamily: "'Montserrat', sans-serif" }}>
      {/* Breadcrumb */}
      <div style={{ padding: "1.5rem", borderBottom: "1px solid #e2e8f0", display: "flex", gap: "8px", fontSize: "13px", color: "#64748b" }}>
      ...
      <div style={{ padding: "3rem 1.5rem 2rem", maxWidth: "1200px", margin: "0 auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "1.5rem", marginBottom: "2rem" }}>
          <div>
            ...
            <p style={{ color: "#475569", fontSize: "16px", lineHeight: 1.7, maxWidth: "600px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem", marginBottom: "2.5rem" }}>
          {features.map(f => (
            <div key={f.label} style={{ backgroundColor: "#ffffff", border: "1px solid #e2e8f0", borderRadius: "10px", padding: "1rem", display: "flex", gap: "10px", alignItems: "flex-start", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
              ...
              <div>
                <div style={{ fontSize: "13px", fontWeight: 700, marginBottom: "2px", color: "#1a1a2e" }}>{f.label}</div>
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto", padding: "0 1.5rem 5rem" }}>
        <div style={{ backgroundColor: "#ffffff", border: "1px solid #e2e8f0", borderRadius: "16px", padding: "2rem", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
          <h2 style={{ fontSize: "18px", fontWeight: 700, marginBottom: "1rem", color: "#1a1a2e" }}>How It Works</h2>
          <p style={{ color: "#475569", fontSize: "14px", lineHeight: 1.7, marginBottom: "1rem" }}>
            ...
            <strong style={{ color: "#1a1a2e" }}>Jaro-Winkler string similarity</strong> to catch misspellings,
            and checks for initial abbreviations and concatenated names.
          </p>
          <p style={{ color: "#475569", fontSize: "14px", lineHeight: 1.7, marginBottom: "1rem" }}>
            When duplicates are found, the record with the <strong style={{ color: "#1a1a2e" }}>most complete name</strong> is
